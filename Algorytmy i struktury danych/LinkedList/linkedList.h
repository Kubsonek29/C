...
typedef linkedListNode* node; // tym razem ukrywamy jeden wskaźnik w definicji linkedListNode;   // wartownik -> element na liscie ktory w data ma maxint -> jego wartosc nigdy nie wystapi na liscie -> zamiast na null konczymy na maxint lub zrobic adres(Wskaznik) na niego SENTINEL
